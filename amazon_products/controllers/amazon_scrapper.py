...
from amazon_products.spiders.AmazonProductsByCategory import AmazonproductsbycategorySpider
...
def run():
    ...
    #runner.crawl(ProductspiderSpider)
    runner.crawl(AmazonproductsbycategorySpider)
